    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for n in range(1, 65):  # Gua numbers from 1 to 64
                line_index = n + 2 - 1  # Adjust to 0-based index (n + 2 is the actual line number)
                if line_index < len(all_lines):
                    ...
                    if line:
                        ...
                        if len(parts) == 3:
                            ...
                            if len(binary_rep) == 6 and all(c in '01' for c in binary_rep):
                                ...
                                print(f"Invalid binary representation for gua {n}: '{binary_rep}'")
                        else:
