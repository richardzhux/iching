...
export function ReadingWorkspace() {
  ...
  if (!result) {
    return (
      <section className="autumn-study autumn-empty mx-auto max-w-2xl border-y border-border bg-surface p-7 text-center sm:p-10">
        <h1 className="autumn-page-title">{locale === "zh" ? "还没有可继续的卦例" : "No active reading yet"}</h1>
  ...
  return <div><ResultsPanel /><div className="mx-auto max-w-5xl px-6 pb-12"><HistoryDrawer /></div></div>
}
