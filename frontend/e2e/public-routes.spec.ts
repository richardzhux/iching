...
const mockedMetaphysicsChart = {
  ...
  birth_profile: {
    ...
    dayun: {
      ...
      direction: "forward",
      cycles: [
        { index: 1, label: "丁丑", ganzhi: "丁丑", start_year: 1996, end_year: 2005, start_age: 6, end_age: 15 },
        { index: 2, label: "戊寅", ganzhi: "戊寅", start_year: 2006, end_year: 2015, start_age: 16, end_age: 25 },
        { index: 3, label: "己卯", ganzhi: "己卯", start_year: 2016, end_year: 2025, start_age: 26, end_age: 35 },
        { index: 4, label: "庚辰", ganzhi: "庚辰", start_year: 2026, end_year: 2035, start_age: 36, end_age: 45 },
      ],
    },
